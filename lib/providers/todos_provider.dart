...
class TodosNotifier extends ChangeNotifier {
  ...
  Future<void> fetchTodos() async {
    try {
      ...
      final response = await dio.get(
          "https:'https://amaliyot-oxiringi-oy-default-rtdb.firebaseio.com/todo.json");
  ...
  Future<void> addTodo(Todo todo) async {
    try {
      ...
      final response = await dio.post(
        "'https://amaliyot-oxiringi-oy-default-rtdb.firebaseio.com/todo.json",
        data: todo.toMap(),
      );
  ...
  Future<void> editTodo(Todo updatedTodo) async {
    try {
      ...
      final dio = Dio();
      await dio.put(
        "'https://amaliyot-oxiringi-oy-default-rtdb.firebaseio.com/todo/${updatedTodo.id}.json",
  ...
  Future<void> deleteTodo(String id) async {
    try {
      ...
      final dio = Dio();
      await dio.delete(
        "'https://amaliyot-oxiringi-oy-default-rtdb.firebaseio.com/todo/$id.json",
      );
